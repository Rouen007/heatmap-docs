...
- [日内交易基础课：科学建仓](./intraday-entry/index.md)
- [Heatmap 五层框架重学](./heatmap/five-layer.md)
- [GEX 日内操作手册](./gex-intraday-guide.md)
- [SPX 已验证规则终稿](./gex-spx-rules-data.md)

## 日内交易学习路径

从“科学建仓”开始，逐步学习盘前地图、开盘环境、突破回踩与失败突破，再用多周期和回踩有效性完成执行确认。课程以价格行为和风险定义为主，GEX、VWAP、成交量与资金流只作为辅助证据。

1. [科学建仓的基本框架](./intraday-entry/01-scientific-entry-framework.md)
